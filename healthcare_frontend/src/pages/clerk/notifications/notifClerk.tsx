...
import NotificationCard, { ClerkNotification } from '../../../components/cards/notifications/clerkNotificationCard'; 
import ClerkSidebar from '../../../components/sidebar/clerkSidebar';

const NotifClerk: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // } else {
            ...
            const mockNotifications: ClerkNotification[] = [
                {
                    read: false,
                    notificationId: '1',
                    clerkId: '123',
            ...
            localStorage.setItem('clerk_notifications', JSON.stringify(mockNotifications));
        }
    }, []);
    ...
    const dismissNotification = (notificationId: string) => {
        ...
        localStorage.setItem('clerk_notifications', JSON.stringify(updatedNotifications));
    };

    return (
        <>
            <Navbar isLoggedIn={true} />
            <ClerkSidebar notificationCount={notifications.filter(notification => !notification.read).length} />            

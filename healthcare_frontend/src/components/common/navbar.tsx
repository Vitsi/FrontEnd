            ...
            <li>
              <details>
                ...
                <ul className="p-2 bg-base-100 rounded-t-none">
                  <li><Link to="/signup-patient">Patient</Link></li> 
                  <li><Link to="/signup-hospital">Hospital</Link></li>              
                </ul>
              </details>
            </li>
          </ul>
...
// Navbar for logged-in users with different roles
const LoggedInNavbar: React.FC<{ profileImage: string | null;}> = ({ profileImage }) => {
  return (
    <nav className="navbar">
      <div className="navbar bg-base-100">
        <div className="flex-1">
...
// Navbar component that dynamically renders based on user state and role
const Navbar: React.FC<{ isLoggedIn: boolean; }> = ({ isLoggedIn}) => {
  return isLoggedIn ? <LoggedInNavbar profileImage={null} /> : <LoggedOutNavbar />;
};

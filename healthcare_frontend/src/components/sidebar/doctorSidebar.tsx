...
const DoctorSidebar : React.FC<DoctorSidebarProps> = ({ notificationCount }) => {
   ...
   const toggleSidebar = () => {
    ...
    return(
        <> 
        <button id="Doctor-sidebar-toggle" 
            ...
            <aside id="Doctor-sidebar" 
               ...
               <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                  <ul className="space-y-2 font-medium">
                     <li>
                        <a href="/doctor-home" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                           <GoHome className="h-6 w-6 mr-1" aria-hidden="true" />
                           <span className="ms-3">Home</span>
                        </a>
                     </li>
                     <li>
                    <a href="/doctor-calendar" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <CiCalendarDate className="h-6 w-6 mr-1" aria-hidden="true" />
                     ...
                     <li>
                        <a href="/doctor-feedback" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
